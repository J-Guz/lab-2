...
post10 = Post.create!(title: "El futuro del trabajo en la era digital", content: "La digitalización está transformando el mundo laboral. Las nuevas tecnologías están cambiando la forma en que trabajamos, desde el teletrabajo hasta la automatización de tareas. Es importante adaptarse a estos cambios y adquirir nuevas habilidades para mantenerse relevante en el mercado laboral. El futuro del trabajo será dinámico y lleno de oportunidades.", author: "elena.morales@example.com", published: 1)

#Comment.create!(content:, author: )
Comment.create!(content: "Este es un comentario de prueba de Juan.", author: "juan.perez@example.com", post: post10)
Comment.create!(content: "María está probando el sistema de comentarios.", author: "maria.gonzalez@example.com", post: post8)
Comment.create!(content: "Carlos ha dejado un comentario interesante.", author: "carlos.rodriguez@example.com", post: post7)
Comment.create!(content: "Ana está participando en la discusión.", author: "ana.martinez@example.com", post: post6)
Comment.create!(content: "Luis ha añadido su opinión.", author: "luis.fernandez@example.com", post: post4)
Comment.create!(content: "Laura comparte sus pensamientos.", author: "laura.sanchez@example.com", post: post2)
Comment.create!(content: "Pedro ha comentado sobre el tema.", author: "pedro.lopez@example.com", post: post5)
Comment.create!(content: "Sofía está contribuyendo con su comentario.", author: "sofia.ramirez@example.com", post: post3)
Comment.create!(content: "Diego ha dejado su punto de vista.", author: "diego.torres@example.com", post: post1)
